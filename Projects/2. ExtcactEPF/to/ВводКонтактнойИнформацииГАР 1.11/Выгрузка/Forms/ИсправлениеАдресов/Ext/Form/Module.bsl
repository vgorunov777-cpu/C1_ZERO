...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка) 
	...
	//
	//Если ИдентификаторПроверки = "РаботаСАдресами_ИсправитьТипЗданияЛитерВАдресах" Тогда
	//	Заголовок = НСтр("ru='Исправление адресов с типом здания Литер'");
	//	Элементы.Пояснение.Заголовок = СтроковыеФункцииКлиентСервер_ПодставитьПараметрыВСтроку(Элементы.Пояснение.Заголовок,
	//		Строка(Параметры.ВидПроверки.Свойство2));
	//ИначеЕсли ИдентификаторПроверки = "РаботаСАдресами_ПроверитьАдресаНаСоответствиеАдресномуКлассификатору" Тогда
	...
	//КонецЕсли;
	//
	//Если ОбщегоНазначения_ЭтоМобильныйКлиент() Тогда
...
Функция ИсправитьУстаревшиеАдресаВФоне(ИдентификаторПроверки)
	...
	//
	//Возврат ДлительныеОперации.ВыполнитьВФоне("РаботаСАдресами_ИсправитьУстаревшиеАдресаВФоне",
...
Функция ИсправитьНекорректныеАдресаВФоне(ИдентификаторПроверки)
	...
	//ПараметрыВыполненияФоновогоЗадания.Вставить("ВидПроверки", Параметры.ВидПроверки);
	//
	//Возврат ДлительныеОперации.ВыполнитьВФоне("РаботаСАдресами_ИсправитьНекорректныеАдресаВФоне",
	//	ПараметрыВыполненияФоновогоЗадания, ПараметрыВыполнения);
...
Функция ИсправитьАдресаСТипомЛитерВФоне(ИдентификаторПроверки)
	...
	//ПараметрыВыполненияФоновогоЗадания.Вставить("ВидПроверки", Параметры.ВидПроверки);
	//
	//Возврат ДлительныеОперации.ВыполнитьВФоне("РаботаСАдресами_ИсправитьТипЗданияЛитерВАдресахВФоне",
	//	ПараметрыВыполненияФоновогоЗадания, ПараметрыВыполнения);
...
Процедура ИсправитьПроблемуВФонеЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	//		Элементы.НадписьУспешноеИсправление.Заголовок = СтроковыеФункцииКлиентСервер_ПодставитьПараметрыВСтроку(
