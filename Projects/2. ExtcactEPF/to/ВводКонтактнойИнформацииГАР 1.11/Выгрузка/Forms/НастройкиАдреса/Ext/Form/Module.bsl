...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипЗнч(Параметры.Объект) = Тип("ДанныеФормыСтруктура") Тогда
		ЗаполнитьЗначенияСвойств(ЭтаФорма, Параметры.Объект);
	КонецЕсли;
	...
	Если ОбщегоНазначения_ЭтоМобильныйКлиент() Тогда
		...
		ОбщегоНазначенияКлиентСервер_УстановитьСвойствоЭлементаФормы(Элементы, "Отмена", "Видимость", Ложь);
		ОбщегоНазначенияКлиентСервер_УстановитьСвойствоЭлементаФормы(Элементы, "Справка", "ТолькоВоВсехДействиях", Истина);
...
&НаСервере 
Функция ОбщегоНазначения_ЭтоМобильныйКлиент() 
...
Процедура ОбщегоНазначенияКлиентСервер_УстановитьСвойствоЭлементаФормы(ЭлементыФормы, ИмяЭлемента, ИмяСвойства, Значение) 
